...
5. Set `GMAIL_ACCOUNTS=you@gmail.com,other@gmail.com` in `.env` (comma-separated, at least one required)
6. Optionally set `TIMEZONE=America/New_York` (or any IANA tz) in `.env` — defaults to `America/Los_Angeles`
